...
Code with poor readability is difficult for other developers to maintain and extend.
...
Documenting your code is another way to improve the maintainability of your code.
