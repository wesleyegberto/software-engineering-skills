...
1. Leverage strict type checking with appropriate compiler flags — apply `/typescript-advanced-types` for generics, conditional types, and mapped types
2. Use generics and utility types for maximum type safety
3. Prefer type inference over explicit annotations when clear
4. Design robust interfaces and abstract classes — apply `/javascript-coding-standards` for naming, structure, and idiomatic patterns
5. Implement proper error boundaries with typed exceptions — apply `/javascript-modern-patterns` for async/await, error handling, and modern ES patterns
6. Write comprehensive tests with typed assertions — apply `/javascript-testing-patterns` for Jest/Vitest test structure and coverage
7. Optimize build times with incremental compilation
8. Before PRs or after significant changes, run `/code-review:code-review` for a full structured review
